...
FILE_PATH = "test_csvs/DP09/B082D_CTD255_18kHz.sv.csv"
...
START_PING = 1800 #2050    # Starting ping number for analysis
END_PING = 3000 #2500      # Ending ping number for analysis (showing 200 pings)
...
DSL_DEPTH_STOP = 250 #430   # Stopping depth in meters for DSL/DVM analysis
...
DSL_SV_THRESHOLD_MIN = -75.5  #75 # Minimum Sv value for a pixel to be considered part of a DSL
DSL_SV_THRESHOLD_MAX = -65.5  #64 # Maximum Sv value for a pixel to be considered part of a DSL

# OpenCV DSL Post-processing
DSL_MIN_CONTOUR_AREA = 2000  #10000# Minimum pixel area to be considered a valid DSL contour
...
DSL_MORPH_KERNEL_SIZE = (2, 2)  # Only used if needed in future
DSL_MORPH_CLOSE_ITERATIONS = 0  # Disabled to preserve layer separation
DSL_MORPH_OPEN_ITERATIONS = 0   # Disabled to preserve layer separation
...
SECOND_PASS_START_PING = 2450  # If None, uses START_PING
SECOND_PASS_END_PING = 3000    # If None, uses END_PING
...
PASS_1_DILATION_KERNEL_SIZE = (7, 7)  # Dilate by ~3 pixels
PASS_1_DILATION_ITERATIONS = 1

# Sv Thresholds for Diffuse Layers
DIFFUSE_DSL_SV_THRESHOLD_MIN = -77.0  # More sensitive threshold
...
DIFFUSE_DSL_CONTOUR_EPSILON_FACTOR = 0.0005  # Different smoothing for diffuse layers